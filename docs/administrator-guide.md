...
| **Public project reference** | Optional visible `REF:` text on future images. Use only a short public identifier (1–16 ASCII letters, digits, spaces, periods, hyphens, underscores, or slashes). A field mark from the action tag adds a second 1–16 character component. Never enter a project title or any sensitive identifier. |
