...
$checkLabels = array(
	...
	'binding_econsent_ip_mac' => $module->framework->tt('ui_check_binding_econsent_ip_mac'), // e-Consent IP binding MAC
...
<div class="sigwm-verification<?= $isAdministrator ? ' sigwm-administrator' : '' ?> mb-5">
    ...
    <?php if ($result !== null): ?>
        ...
        <?php
        $econsentIpDiagnostic = isset($result['econsent_ip_diagnostic']) && is_array($result['econsent_ip_diagnostic'])
