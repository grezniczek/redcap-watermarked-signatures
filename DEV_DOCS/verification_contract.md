...
menu visibility. Plaintext e-Consent and data-entry capture IP addresses remain
separately restricted to users who can access the enabled Database Query Tool.
