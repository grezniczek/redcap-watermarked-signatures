...
| 1.0.4   | Added encrypted upload-time IP provenance for signatures on e-Consent-enabled surveys, a diagnostic comparison against REDCap's stored e-Consent IP, and Database-Query-Tool-gated administrator disclosure. Made global verification available to authorized Control Center dashboard users. |
