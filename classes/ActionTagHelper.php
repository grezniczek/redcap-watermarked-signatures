<?php namespace DE\RUB\WatermarkedSignaturesExternalModule;
...
class ActionTagHelper
{
	...
	/** @var array<string, array<string, array{params: mixed}>> */
	static $cache = array();

	/**
	 * This is a utility function to return action tags, fields, and parameters for specific action-tag scripts
	 *
	 * @param string|array<int, string>|null $tags A single or array of action tags to find.
	 * @param string|array<int, string>|null $fields A single or array of fields to search.
	 * @param string|array<int, string>|null $instruments A single or array of instruments to search.
	 * @throws \Exception
	 * @return array<string, array<string, array{params: mixed}>> Action tags indexed by tag and field name.
	 */
	 ...
	 *
	 * @param string $string The string to parse for action tags.
	 * @param string|null $tag_only Optional single tag to select.
	 * @return array<int, array{actiontag: string, params: string, match: string}>|false Parsed action tags, or false when none are found.
	 */
