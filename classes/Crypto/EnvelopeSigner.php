...
class EnvelopeSigner
{
	...
	/**
	 * @param array<string, mixed> $payload Signature-capture envelope payload.
	 * @return string Canonical, base64url-encoded payload and MAC.
	 */
	...
	/**
	 * @param string $envelope Signed signature-capture envelope.
	 * @return array<string, mixed> Verified canonical payload.
	 */
